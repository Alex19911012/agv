...
@RestController
@RequestMapping("/day")
public class DayWorkOrderController extends BaseController{
	@Autowired
	private IDayWorkOrderService DayWorkOrderService;
	
	
	
	@GetMapping("/workOrder")
	public ResponseResult<List<DayWorkOrder>> OAGVTList() {	
		System.err.println("请求日订单数量");
		List<DayWorkOrder> data = DayWorkOrderService.findDayWorkOrders();
		return new ResponseResult<List<DayWorkOrder>>(SUCCESS,data);
	}
