 ...
 */
@Service
public class DayWorkOrderServiceImpl implements IDayWorkOrderService {

	
	@Autowired
	private DayWorkOrderMapper DayWorkOrderMapper;

	@Override
	public List<DayWorkOrder> findDayWorkOrders() {
		return getDayWorkOrders();
	}
	
	private List<DayWorkOrder> getDayWorkOrders(){
		return DayWorkOrderMapper.getDayWorkOrders();
	}
